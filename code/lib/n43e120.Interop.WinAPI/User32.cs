...
namespace n43e120.Interop.WinAPI
{
    ...
    [StructLayout(LayoutKind.Sequential)]
    unsafe public struct KBDLLHOOKSTRUCT
    {
        public Int32 vkCode;
    ...
    [StructLayout(LayoutKind.Sequential)]
    unsafe public struct MSLLHOOKSTRUCT
    {
        public POINT pt;
    ...
    /// </summary>
    /// <seealso cref="http://wenku.baidu.com/link?url=NEzWYQa1PBbE1Euk5r1bwLPPC3pGY4mHguWeOag8A63ZQqEqP0yDVbSHWekjma62HOleDM4bCn0Nz_bVKweMpfg3OACPriI0g68RCOHjGQa"/>
    public enum WM : uint
    {
        WM_NULL = 0x0000,
        WM_CREATE = 0x0001,
    ...
    public static class User32
    {
        ...
        public static extern void mouse_event(MOUSEEVENTF dwFlags, int dx, int dy, uint dwData, UIntPtr dwExtraInfo);
        ...
        public static extern IntPtr SetWindowsHookEx(User32.WH idHook, HOOKPROC lpfn, IntPtr hMod, uint dwThreadId);
