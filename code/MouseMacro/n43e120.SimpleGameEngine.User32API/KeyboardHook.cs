...
{
    public class KeyboardHook : IDisposable, ISignalOnOff
    {
        IntPtr hHookProc = IntPtr.Zero;
        User32.HOOKPROC HookProc;
        public KeyboardHook(User32.HOOKPROC h)
        {
            this.HookProc = h;
        }
        public void Start()
...
//            //SetWindowsHookEx(WH_KEYBOARD_LL,MouseHookProcedure,Marshal.GetHINSTANCE(Assembly.GetExecutingAssembly().GetModules()[0]),0);
//            //
...
//    private unsafe int KeyboardHookProc(int nCode, Int32 wParam, IntPtr lParam)
//    {
//        // 侦听键盘事件
...
//            KBDLLHOOKSTRUCT* p = (KBDLLHOOKSTRUCT*)lParam;
//            //ref KeyboardHookStruct refstr = ref MyKeyboardHookStruct;
//            //Marshal.PtrToStructure(lParam, MyKeyboardHookStruct);
//            // raise KeyDown
//            if (KeyDownEvent != null && (wParam == WM_KEYDOWN || wParam == WM_SYSKEYDOWN))
//            {
//                Keys keyData = (Keys)(*p).vkCode;
...
//                if (ToAscii((*p).vkCode, (*p).scanCode, keyState, inBuffer, (*p).flags) == 1)
//                {
